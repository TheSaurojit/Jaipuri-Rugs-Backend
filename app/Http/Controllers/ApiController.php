...
class ApiController extends Controller
{
    ...
    {
        $product = Product::where('id', $productId)->where('is_active', true)->with('multipleImages:product_id,path', 'category:id,name' , 'variations:id,product_id,shape_id,size,price' ,'variations.shape')->first();
